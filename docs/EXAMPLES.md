...
**[`examples/basic/hello.ot`](../examples/basic/hello.ot)**
...
**[`examples/basic/enum_demo.ot`](../examples/basic/enum_demo.ot)**
...
**[`examples/advanced_syntax_test.ot`](../examples/advanced_syntax_test.ot)**
...
**[`examples/basic/struct_demo.ot`](../examples/basic/struct_demo.ot)**
...
**[`examples/basic/struct_methods_demo.ot`](../examples/basic/struct_methods_demo.ot)**
...
**[`examples/basic/generic_struct_test.ot`](../examples/basic/generic_struct_test.ot)**
...
**[`examples/basic/advanced_pipeline.ot`](../examples/basic/advanced_pipeline.ot)**
...
**[`examples/basic/http_request.ot`](../examples/basic/http_request.ot)**
...
**[`examples/basic/sqrt_approx.ot`](../examples/basic/sqrt_approx.ot)**
- **Purpose**: Square root approximation using Newton's method
- **Demonstrates**: Recursive algorithms, floating-point operations, convergence
- **Run**: `otter run examples/basic/sqrt_approx.ot`

### Error Handling

**[`examples/basic/error_handling_basics.ot`](../examples/basic/error_handling_basics.ot)**
...
**[`examples/basic/error_handling_advanced.ot`](../examples/basic/error_handling_advanced.ot)**
...
**[`examples/basic/error_handling_resource.ot`](../examples/basic/error_handling_resource.ot)**
...
**[`examples/basic/error_handling_validation.ot`](../examples/basic/error_handling_validation.ot)**
...
**[`examples/basic/yaml_demo.ot`](../examples/basic/yaml_demo.ot)**
...
**[`examples/basic/task_benchmark.ot`](../examples/basic/task_benchmark.ot)**
...
**[`examples/ffi/test_ffi_struct.ot`](../examples/ffi/test_ffi_struct.ot)**
...
1. **Start here**: [`hello.ot`](../examples/basic/hello.ot) → [`enum_demo.ot`](../examples/basic/enum_demo.ot) → [`struct_demo.ot`](../examples/basic/struct_demo.ot)
2. **Control flow**: [`fibonacci.ot`](../examples/basic/fibonacci.ot) → [`advanced_pipeline.ot`](../examples/basic/advanced_pipeline.ot)
3. **Error handling**: [`error_handling_basics.ot`](../examples/basic/error_handling_basics.ot) → [`error_handling_advanced.ot`](../examples/basic/error_handling_advanced.ot)
4. **Interop**: [`http_request.ot`](../examples/basic/http_request.ot) → [`test_ffi_struct.ot`](../examples/ffi/test_ffi_struct.ot)
